...
public class SpringConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, TokenFilter tokenFilter) throws Exception {
        ...
        http.authorizeHttpRequests(api -> api
                ...
                .requestMatchers(HttpMethod.GET, "/User/verify/ForgetPassword").permitAll()
                .requestMatchers(HttpMethod.PUT, "/User/ForgetPassword/newPassword").permitAll()
                .requestMatchers(HttpMethod.GET, "/User/forget_password").permitAll()
